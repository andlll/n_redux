/// gml_Object_IMPAMEDIA_FD_DEMO_Alarm_0
// locals: __b__
action_set_relative(0);
__b__ = action_if_variable(tic, 0, 0);
if (__b__) {
    action_sprite_set(fd15, 0, 1);
...
if (__b__) {
    ...
    if (__b__) {
        __b__ = action_if_dice(2);
        if (__b__) {
            action_sprite_set(fd21, 0, 1);
        } else {
            action_sprite_set(fd22, 0, 1);
        }
    } else {
        __b__ = action_if_dice(2);
        if (__b__) {
            action_sprite_set(fd23, 0, 1);
        } else {
            action_sprite_set(fd24, 0, 1);
        }
    }
    action_set_alarm(40, 0);
    action_set_relative(1);
...
if (__b__) {
    ...
    if (__b__) {
        __b__ = action_if_dice(2);
        if (__b__) {
            action_sprite_set(fd31, 0, 1);
        } else {
            action_sprite_set(fd32, 0, 1);
        }
    } else {
        __b__ = action_if_dice(2);
        if (__b__) {
            action_sprite_set(fd33, 0, 1);
        } else {
            action_sprite_set(fd34, 0, 1);
        }
    }
    action_set_alarm(40, 0);
    action_set_relative(1);
...
if (__b__) {
    ...
    if (__b__) {
        __b__ = action_if_dice(2);
        if (__b__) {
            action_sprite_set(fd41, 0, 1);
        } else {
            action_sprite_set(fd42, 0, 1);
        }
    } else {
        __b__ = action_if_dice(2);
        if (__b__) {
            action_sprite_set(fd43, 0, 1);
        } else {
            action_sprite_set(fd44, 0, 1);
        }
    }
    action_set_alarm(40, 0);
    action_set_relative(1);
...
if (__b__) {
    __b__ = action_if_dice(2);
    if (__b__) {
        action_sprite_set(df51, 0, 1);
    } else {
        action_sprite_set(df52, 0, 1);
    }
    action_set_alarm(40, 0);
    action_set_relative(1);
    tic = tic + 1;
...
if (__b__) {
    __b__ = action_if_dice(2);
    if (__b__) {
        action_sprite_set(df61, 0, 1);
    } else {
        action_sprite_set(df62, 0, 1);
    }
    action_set_alarm(40, 0);
    action_set_relative(1);
    tic = tic + 1;
...
if (__b__) {
    __b__ = action_if_dice(2);
    if (__b__) {
        action_sprite_set(df71, 0, 1);
    } else {
        action_sprite_set(df72, 0, 1);
    }
    action_set_alarm(40, 0);
    action_set_relative(1);
    tic = tic + 1;
...
if (__b__) {
    __b__ = action_if_dice(2);
    if (__b__) {
        action_sprite_set(df82, 0, 1);
    } else {
        action_sprite_set(df81, 0, 1);
    }
    action_set_alarm(40, 0);
    action_set_relative(1);
    tic = tic + 1;
