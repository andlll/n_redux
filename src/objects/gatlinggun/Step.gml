...
if (__b__) {
    ...
    if (__b__) {
        __b__ = action_if_variable(spra, 0, 0);
        if (__b__) {
...
if (__b__) {
    action_create_object(gatlingdeath, 0, 0);
...
__b__ = action_if_number(15, 0, 2);
if (__b__) {
    __b__ = action_if_variable(distance_to_object(nemici_target), 450, 1);
    if (__b__) {
        __b__ = action_if_variable(launching, 1, 0);
        if (__b__) {
            direttorio = point_direction(x, y, instance_nearest(x, y, veicoli_target).x, instance_nearest(x, y, veicoli_target).y);
...
__b__ = action_if_variable(amove, 0, 0);
if (__b__) {
    __b__ = action_if_variable(launching, 1, 0);
    if (__b__) {
        __b__ = action_if_variable(spra, 1, 0);
        if (__b__) {
            alarm[11] = 3;
            alarm[6] = 6;
            amove = 1;
