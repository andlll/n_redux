/// gml_Object_industria1_Step_0
// locals: __b__
action_set_relative(1);
__b__ = action_if_variable(upo, 0, 0);
if (__b__) {
    __b__ = action_if_variable(makee, 667, 4);
    if (__b__) {
        action_create_object(upind12, 0, 0);
...
if (__b__) {
    action_create_object(ruin1, 0, 0);
    action_create_object(updeathind1, 0, 0);
    action_kill_object();
}
