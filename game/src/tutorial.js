...
const TUTORIAL_TEXTS_IT = [
  ...
  "Per fornire energia alla città usiamo delle centrali elettriche. Se l'energia scende sotto zero, i nostri cittadini smetteranno di pagare le tasse!",
  "Ora costruisci una centrale elettrica in un lotto vuoto! Ricorda che il consumo di energia dipende dalla popolazione, quindi continuerà a crescere",
  "Dobbiamo anche garantire loro un po' di aria pulita e svago, e per farlo puoi costruire dei parchi",
  "Nota che più crescono popolazione e centrali elettriche, più avranno bisogno di parchi!",
  ...
  "Usiamo le armi anche per portare via risorse al nemico, che le trasporta in quelle enormi mongolfiere che vedi volare sopra di noi!",
  ...
  "Le centrali elettriche e i motori della città bruciano petrolio per funzionare. Più la città pesa, più consuma petrolio!",
  "Quindi ricorda di non costruire cose inutili o troppe centrali elettriche, o la città cadrà al suolo!",
...
const TUTORIAL_TEXTS_ES = [
  ...
  "Para dar energía a la ciudad usamos centrales eléctricas. Si la energía baja de cero, ¡nuestros ciudadanos dejarán de pagar impuestos!",
  ...
  "¡Fíjate en que cuanto más crecen la población y las centrales eléctricas, más parques necesitarán!",
  ...
  "Las centrales eléctricas y los motores de la ciudad queman petróleo para funcionar. ¡Cuanto más pesa la ciudad, más petróleo consume!",
  "Así que recuerda no construir cosas innecesarias ni demasiadas centrales eléctricas, ¡o la ciudad caerá al suelo!",
...
const TUTORIAL_TEXTS_PT = [
  ...
  "As usinas elétricas e os motores da cidade queimam petróleo para funcionar. Quanto mais pesada a cidade, mais petróleo consome!",
  "Então lembre-se de não construir coisas desnecessárias nem usinas elétricas demais, ou a cidade cairá ao chão!",
...
const TUTORIAL_TEXTS_DE = [
  ...
  "Die untere Leiste dagegen ist die Aktionsleiste. Benutze den Hand-Button, um Werkzeuge auszuwählen",
  ...
  "Baue jetzt ein Kraftwerk auf einem leeren Grundstück! Denk daran, dass der Energieverbrauch von der Bevölkerung abhängt, also wird er stetig weiterwachsen",
  "Wir müssen ihnen auch etwas saubere Luft und Unterhaltung bieten, und dafür kannst du Parks bauen",
  "Beachte, dass je mehr Bevölkerung und Kraftwerke wachsen, desto mehr Parks werden benötigt!",
  ...
  "Denk also daran, keine unnötigen Dinge oder zu viele Kraftwerke zu bauen, sonst stürzt die Stadt zu Boden!",
...
const TUTORIAL_TEXTS_FR = [
  ...
  "Construis maintenant une centrale électrique sur un emplacement vide ! N'oublie pas que la consommation d'énergie dépend de la population, donc elle continuera d'augmenter",
  "On doit aussi leur offrir un peu d'air pur et de distraction, et pour ça tu peux construire des parcs",
  "Remarque que plus la population et les centrales électriques grandissent, plus ils auront besoin de parcs !",
  ...
  "Alors n'oublie pas de ne pas construire de choses inutiles ni trop de centrales électriques, sinon la ville s'écrasera au sol !",
