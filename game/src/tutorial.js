...
const TUTORIAL_TEXTS_IT = [
  ...
  "Per fornire energia alla città costruiamo delle centrali elettriche. Se l'energia scende sotto zero, i nostri cittadini smetteranno di pagare le tasse!",
...
const TUTORIAL_TEXTS_ES = [
  ...
  "Para dar energía a la ciudad construimos centrales eléctricas. Si la energía baja de cero, ¡nuestros ciudadanos dejarán de pagar impuestos!",
