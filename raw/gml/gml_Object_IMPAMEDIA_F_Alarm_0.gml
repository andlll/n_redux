/// gml_Object_IMPAMEDIA_F_Alarm_0
// locals: __b__
...
if (__b__) {
    __b__ = action_if_dice(2);
    if (__b__) {
        action_sprite_set(sf51, 0, 1);
    } else {
        action_sprite_set(sf52, 0, 1);
    }
    action_set_alarm(40, 0);
    action_set_relative(1);
    tic = tic + 1;
...
if (__b__) {
    __b__ = action_if_dice(2);
    if (__b__) {
        action_sprite_set(sf61, 0, 1);
    } else {
        action_sprite_set(sf62, 0, 1);
    }
    action_set_alarm(40, 0);
    action_set_relative(1);
    tic = tic + 1;
...
if (__b__) {
    __b__ = action_if_dice(2);
    if (__b__) {
        action_sprite_set(sf71, 0, 1);
    } else {
        action_sprite_set(sf72, 0, 1);
    }
    action_set_alarm(40, 0);
    action_set_relative(1);
    tic = tic + 1;
...
if (__b__) {
    __b__ = action_if_dice(2);
    if (__b__) {
        action_sprite_set(sf82, 0, 1);
    } else {
        action_sprite_set(sf81, 0, 1);
    }
    action_set_alarm(40, 0);
    action_set_relative(1);
    tic = tic + 1;
