...
if (__b__) {
    action_set_relative(1);
    action_create_object(MEDIALITE1D, 0, 0);
    action_set_relative(0);
    action_sprite_set(med1d, 0, 1);
} else {
    action_set_relative(1);
    action_create_object(MEDIALITE2D, 0, 0);
    action_set_relative(0);
    action_sprite_set(med2d, 0, 1);
}
action_set_relative(0);
