/// gml_Object_impalasdem_f_Alarm_0
// locals: __b__
...
if (__b__) {
    ...
    if (__b__) {
        __b__ = action_if_dice(2);
        if (__b__) {
            action_sprite_set(if33, 0, 1);
        } else {
            action_sprite_set(if34, 0, 1);
        }
    } else {
        __b__ = action_if_dice(2);
        if (__b__) {
            action_sprite_set(if35, 0, 1);
        } else {
            action_sprite_set(if36, 0, 1);
        }
    }
    action_set_alarm(40, 0);
    action_set_relative(1);
...
if (__b__) {
    ...
    if (__b__) {
        __b__ = action_if_dice(2);
        if (__b__) {
            action_sprite_set(if43, 0, 1);
        } else {
            action_sprite_set(if44, 0, 1);
        }
    } else {
        __b__ = action_if_dice(2);
        if (__b__) {
            action_sprite_set(if45, 0, 1);
        } else {
            action_sprite_set(if46, 0, 1);
        }
    }
    action_set_alarm(40, 0);
    action_set_relative(1);
...
if (__b__) {
    action_set_relative(1);
    action_create_object(tops3i, 0, -170);
    action_set_relative(0);
    action_set_relative(1);
    action_create_object(laserdeath, 0, 0);
    action_set_relative(0);
    action_set_alarm(1330, 5);
    action_set_alarm(1400, 0);
    action_set_relative(1);
    tic = tic + 1;
    action_set_relative(0);
    action_set_relative(0);
...
if (__b__) {
    ...
    action_set_relative(0);
    action_set_relative(1);
    action_create_object(placeholder, 0, 0);
    action_set_relative(0);
    action_set_relative(0);
    exit;
}
