// gml_Object_media1s_Alarm_3  locals=2 args=0 len=396
...
00000068: conv.v.b
0000006C: bf 0x20DC09C
00000070: b 0x20DC0A4
00000074: popenv 0x40DC060
00000078: b 0x20DC0A8
0000007C: popenv 0x1CDC0A4
00000080: push.local.v local.__b__
00000088: conv.v.b
0000008C: bf 0x20DC108
00000090: push.imm.e 156
00000094: pushenv 0x20DC100
...
000000D4: popz
000000D8: popenv 0x40DC0C0
000000DC: b 0x20DC154
000000E0: push.imm.e 156
000000E4: pushenv 0x20DC150
...
00000124: popz
00000128: popenv 0x40DC110
0000012C: push.imm.e 156
00000130: pushenv 0x20DC19C
