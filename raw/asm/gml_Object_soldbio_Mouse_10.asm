// gml_Object_soldbio_Mouse_10  locals=1 args=0 len=152
// locals: arguments
...
00000058: pushenv 0x20F60A4
0000005C: push.v biotech
00000064: push.imm.e 1
00000068: add.i.v
0000006C: pop.v.v biotech
00000074: popenv 0x40F608C
