// gml_Object_laserone_Collision_85  locals=2 args=0 len=388
...
00000118: popenv 0x410EE78
0000011C: push.local.v local.__b__
00000124: conv.v.b
00000128: bf 0x210EEF8
0000012C: push.v other.id
00000134: conv.v.i
00000138: pushenv 0x210EEE8
