// gml_Object_demobasia_Collision_197  locals=2 args=0 len=348
...
00000044: conv.v.b
00000048: bf 0x20BDD80
0000004C: push.imm.e 156
00000050: pushenv 0x20BDCC8
