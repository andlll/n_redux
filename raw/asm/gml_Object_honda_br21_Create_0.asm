// gml_Object_honda_br21_Create_0  locals=2 args=0 len=240
...
000000A8: conv.v.b
000000AC: bf 0x20A9B74
000000B0: b 0x20A9B7C
000000B4: popenv 0x40A9B38
000000B8: b 0x20A9B80
000000BC: popenv 0x1CA9B7C
000000C0: push.local.v local.__b__
000000C8: conv.v.b
000000CC: bf 0x20A9BB0
