// gml_Object_stella1_Mouse_11  locals=2 args=0 len=360
...
00000030: conv.v.b
00000034: bf 0x21DF198
00000038: push.imm.e 156
0000003C: pushenv 0x21DF124
00000040: push.imm.e 0
00000044: conv.i.v
00000048: push.imm.e 71
0000004C: conv.i.v
...
00000070: conv.v.b
00000074: bf 0x21DF124
00000078: b 0x21DF12C
0000007C: popenv 0x41DF0E8
00000080: b 0x21DF130
00000084: popenv 0x1DDF12C
00000088: push.local.v local.__b__
00000090: conv.v.b
00000094: bf 0x21DF168
00000098: push.imm.e 1
0000009C: conv.i.v
000000A0: push.imm.e 0
000000A4: conv.i.v
000000A8: push.imm.e 461
000000AC: conv.i.v
000000B0: call action_sprite_set(argc=3)
000000B8: popz
000000BC: b 0x21DF18C
000000C0: push.imm.e 1
000000C4: conv.i.v
000000C8: push.imm.e 0
000000CC: conv.i.v
000000D0: push.imm.e 460
000000D4: conv.i.v
...
000000F4: pushenv 0x21DF1AC
000000F8: call action_kill_object(argc=0)
00000100: popz
00000104: popenv 0x41DF1A0
00000108: push.imm.e 146
0000010C: pushenv 0x21DF1C4
00000110: call action_kill_object(argc=0)
00000118: popz
0000011C: popenv 0x41DF1B8
00000120: push.imm.e 679
00000124: pushenv 0x21DF1DC
00000128: call action_kill_object(argc=0)
00000130: popz
00000134: popenv 0x41DF1D0
00000138: push.imm.e 654
0000013C: pushenv 0x21DF1F4
00000140: call action_kill_object(argc=0)
00000148: popz
0000014C: popenv 0x41DF1E8
00000150: push.imm.e 668
00000154: pushenv 0x21DF20C
00000158: call action_kill_object(argc=0)
00000160: popz
00000164: popenv 0x41DF200