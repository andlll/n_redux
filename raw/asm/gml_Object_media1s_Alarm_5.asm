// gml_Object_media1s_Alarm_5  locals=2 args=0 len=344
...
00000068: conv.v.b
0000006C: bf 0x20DBF44
00000070: b 0x20DBF4C
00000074: popenv 0x40DBF08
00000078: b 0x20DBF50
0000007C: popenv 0x1CDBF4C
00000080: push.local.v local.__b__
00000088: conv.v.b
0000008C: bf 0x20DC014
00000090: push.imm.e 108
00000094: conv.i.v
00000098: call action_if_dice(argc=1)
000000A0: pop.v.v local.__b__
000000A8: push.local.v local.__b__
000000B0: conv.v.b
000000B4: bf 0x20DC014
000000B8: push.imm.e 1
000000BC: conv.i.v
000000C0: call action_set_relative(argc=1)
000000C8: popz
000000CC: push.imm.e -100
000000D0: conv.i.v
