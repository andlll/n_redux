// gml_Object_laserone_retro_Collision_77  locals=2 args=0 len=376
...
00000118: popenv 0x410FDAC
0000011C: push.local.v local.__b__
00000124: conv.v.b
00000128: bf 0x210FE20
0000012C: push.v other.id
00000134: conv.v.i
00000138: pushenv 0x210FE1C
