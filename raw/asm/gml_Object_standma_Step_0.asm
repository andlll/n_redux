// gml_Object_standma_Step_0  locals=1 args=0 len=364
// locals: arguments
...
000000B4: div.d.v
000000B8: add.v.v
000000BC: push.imm.e 90
000000C0: sub.i.v
000000C4: pop.v.v y
000000CC: b 0x21ECAFC
