// gml_Object_pu6_Mouse_11  locals=2 args=0 len=312
...
00000030: conv.v.b
00000034: bf 0x21E23B0
00000038: push.imm.e 156
0000003C: pushenv 0x21E233C
00000040: push.imm.e 0
00000044: conv.i.v
00000048: push.imm.e 6
0000004C: conv.i.v
...
00000070: conv.v.b
00000074: bf 0x21E233C
00000078: b 0x21E2344
0000007C: popenv 0x41E2300
00000080: b 0x21E2348
00000084: popenv 0x1DE2344
00000088: push.local.v local.__b__
00000090: conv.v.b
00000094: bf 0x21E2380
00000098: push.imm.e 1
0000009C: conv.i.v
000000A0: push.imm.e 0
000000A4: conv.i.v
000000A8: push.imm.e 516
000000AC: conv.i.v
000000B0: call action_sprite_set(argc=3)
000000B8: popz
000000BC: b 0x21E23A4
000000C0: push.imm.e 1
000000C4: conv.i.v
000000C8: push.imm.e 0
000000CC: conv.i.v
000000D0: push.imm.e 514
000000D4: conv.i.v
000000D8: call action_sprite_set(argc=3)
000000E0: popz
000000E4: push.imm.e 0
000000E8: pop.v.i over
000000F0: push.imm.e 662
000000F4: pushenv 0x21E23C4
000000F8: call action_kill_object(argc=0)
00000100: popz
00000104: popenv 0x41E23B8
00000108: push.imm.e 688
0000010C: pushenv 0x21E23DC
00000110: call action_kill_object(argc=0)
00000118: popz
0000011C: popenv 0x41E23D0
00000120: push.imm.e 680
00000124: pushenv 0x21E23F4
00000128: call action_kill_object(argc=0)
00000130: popz
00000134: popenv 0x41E23E8