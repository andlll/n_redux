// gml_Object_yellow_pro_Collision_77  locals=2 args=0 len=180
...
00000080: popenv 0x40C2238
00000084: push.local.v local.__b__
0000008C: conv.v.b
00000090: bf 0x20C2280
