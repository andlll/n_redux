// gml_Object_honda21a_Create_0  locals=2 args=0 len=376
...
000000A0: conv.v.b
000000A4: bf 0x20ABACC
000000A8: b 0x20ABAD4
000000AC: popenv 0x40ABA90
000000B0: b 0x20ABAD8
000000B4: popenv 0x1CABAD4
000000B8: push.local.v local.__b__
000000C0: conv.v.b
000000C4: bf 0x20ABB08
