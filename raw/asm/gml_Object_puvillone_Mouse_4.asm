// gml_Object_puvillone_Mouse_4  locals=2 args=0 len=164
...
00000090: pushenv 0x21E3FE4
00000094: push.imm.e 63
00000098: pop.v.i selec
000000A0: popenv 0x41E3FD8