// gml_Object_pusolare_Mouse_4  locals=2 args=0 len=164
...
00000090: pushenv 0x21E32E4
00000094: push.imm.e 61
00000098: pop.v.i selec
000000A0: popenv 0x41E32D8