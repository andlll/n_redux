// gml_Object_red_ball_Collision_77  locals=2 args=0 len=208
...
00000078: popenv 0x4110F7C
0000007C: push.local.v local.__b__
00000084: conv.v.b
00000088: bf 0x2110FE8
