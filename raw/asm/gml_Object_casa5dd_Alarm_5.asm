// gml_Object_casa5dd_Alarm_5  locals=2 args=0 len=344
...
00000068: conv.v.b
0000006C: bf 0x20E365C
00000070: b 0x20E3664
00000074: popenv 0x40E3620
00000078: b 0x20E3668
0000007C: popenv 0x1CE3664
00000080: push.local.v local.__b__
00000088: conv.v.b
0000008C: bf 0x20E372C
00000090: push.imm.e 76
00000094: conv.i.v
00000098: call action_if_dice(argc=1)
000000A0: pop.v.v local.__b__
000000A8: push.local.v local.__b__
000000B0: conv.v.b
000000B4: bf 0x20E372C
000000B8: push.imm.e 1
000000BC: conv.i.v
000000C0: call action_set_relative(argc=1)
000000C8: popz
000000CC: push.imm.e -180
000000D0: conv.i.v
