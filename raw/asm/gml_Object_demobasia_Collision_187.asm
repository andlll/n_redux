// gml_Object_demobasia_Collision_187  locals=2 args=0 len=348
...
00000044: conv.v.b
00000048: bf 0x20BE750
0000004C: push.imm.e 156
00000050: pushenv 0x20BE698
00000054: push.imm.e 4
00000058: conv.i.v
0000005C: push.imm.e 500
00000060: conv.i.v
00000064: push.v mon
...
00000084: conv.v.b
00000088: bf 0x20BE698
0000008C: b 0x20BE6A0
00000090: popenv 0x40BE65C
00000094: b 0x20BE6A4
00000098: popenv 0x1CBE6A0
0000009C: push.local.v local.__b__
000000A4: conv.v.b
000000A8: bf 0x20BE750
000000AC: push.imm.e 156
000000B0: pushenv 0x20BE6D4
000000B4: push.v mon
000000BC: push.imm.e -500
000000C0: add.i.v
000000C4: pop.v.v mon
000000CC: popenv 0x40BE6BC
000000D0: push.imm.e 0
000000D4: conv.i.v
000000D8: push.imm.e 0
000000DC: conv.i.v
000000E0: push.imm.e 570
000000E4: conv.i.v
000000E8: call action_create_object(argc=3)
000000F0: popz
000000F4: push.imm.e 128
000000F8: pushenv 0x20BE710
000000FC: call action_kill_object(argc=0)
00000104: popz
00000108: popenv 0x40BE704
0000010C: push.imm.e 130
00000110: pushenv 0x20BE728
00000114: call action_kill_object(argc=0)
0000011C: popz
00000120: popenv 0x40BE71C
00000124: push.imm.e 129
00000128: pushenv 0x20BE740
0000012C: call action_kill_object(argc=0)
00000134: popz
00000138: popenv 0x40BE734
